...
// (1) https://docs.rust-embedded.org/discovery/microbit/11-snake-game/game-logic.html
// A related reference:
// (2) https://github.com/rust-embedded/discovery/blob/master/microbit/src/11-snake-game/src/game.rs
...
// (2) Snake game - Random number generation
//
// TODO [ ] substitute the hardware based RNG
// TODO [ ] test whether hardware RNG runs fast enough to allow
//           10 Hz "Game of Life" display updates.
...
// (3) Snake game - Enums
//
// The Discovery MB book chapter 11 introduces Snake Game elements in
// the order they're copied in to this file.  Enums for game state come next:
...
// (4) Structure for the snake and methods to move it
...
// (5) Game State and Overarching Logic
